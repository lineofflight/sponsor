...
module Sponsor
  ...
  class SponsoredProducts < API
    ...
    #: (Numeric, ?max_num_suggestions: Integer?, ?ad_state_filter: String?) -> HTTP::Response
    ...
    #: (Numeric, ?max_num_suggestions: Integer?, ?suggest_bids: String?, ?ad_state_filter: String?) -> HTTP::Response
    ...
    #: (String, ?max_num_suggestions: Integer?) -> HTTP::Response
